...
using System.IO;
using Hlp.Sped.Controllers.Contabil;
...
{
    public partial class FormSpedContabil : Form, IObserverAsynchronousExecution
    {
        private FrontController _FrontController;

        public FormSpedContabil()
        {
            InitializeComponent();
        }
        ...
        private void ExecuteContabilProcessController(BaseController controller)
        {
        ...
        private void FormSpedContabil_Load(object sender, EventArgs e)
        {
        ...
        private void FormSpedContabil_KeyDown(object sender, KeyEventArgs e)
        {
