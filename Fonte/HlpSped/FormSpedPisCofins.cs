...
using Hlp.Sped.Controllers.Fiscal.PisCofins;
...
{
    public partial class FormSpedPisCofins : Form, IObserverAsynchronousExecution
    {
        private FrontController _FrontController;

        public FormSpedPisCofins()
        {
            InitializeComponent();
        }

        private void FormSpedPisCofins_KeyDown(object sender, KeyEventArgs e)
        {
        ...
        private void FormSpedPisCofins_Shown(object sender, EventArgs e)
        {
        }

        private void FormSpedPisCofins_Load(object sender, EventArgs e)
        {
            ...
            this.ConfigurarPreenchimentoNumReciboAnterior(
                this.rdbRemesssaSubstituta.Checked);
        }

        private void rdbTipoRemessa_CheckedChanged(object sender, EventArgs e)
        {
            this.ConfigurarPreenchimentoNumReciboAnterior(
                this.rdbRemesssaSubstituta.Checked);
        }
        ...
        private void ExecutePisCofinsProcessController(BaseController controller)
        {
        ...
        private void ConfigurarPreenchimentoNumReciboAnterior(bool retificacao)
        {
            lblDescNumeroReciboAnterior.Enabled = retificacao;
            txtNumeroReciboAnterior.Enabled = retificacao;
            if (!retificacao)
                txtNumeroReciboAnterior.Text = String.Empty;
        }
    }
}