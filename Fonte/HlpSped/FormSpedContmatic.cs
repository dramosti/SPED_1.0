...
using Hlp.Sped.Controllers.Contmatic;
...
{
    public partial class FormSpedContmatic : Form, IObserverAsynchronousExecution
    {
        private Hlp.Sped.Controllers.Fiscal.FrontController _FrontController;

        public FormSpedContmatic()
        {
            InitializeComponent();
        }

        private void FormSpedContmatic_KeyDown(object sender, KeyEventArgs e)
        {
        ...
        private void FormSpedContmatic_Load(object sender, EventArgs e)
        {
            _FrontController = new Hlp.Sped.Controllers.Fiscal.FrontController();
        ...
        private void ExecuteContmaticProcessController(BaseController controller)
        {
