...
{
    public partial class FormSpedFiscal : Form, IObserverAsynchronousExecution
    {
        ...
        private void btnProcessar_Click(object sender, EventArgs e)
        {
            ...
            FiscalProcessController controller = new FiscalProcessController(parameters);
            controller.Initialize();
            ExecuteAsynchronousControllerDelegate execucaoController =
                new ExecuteAsynchronousControllerDelegate(ExecuteFiscalProcessController);
        ...
        private void ExecuteFiscalProcessController(BaseController controller)
        {
