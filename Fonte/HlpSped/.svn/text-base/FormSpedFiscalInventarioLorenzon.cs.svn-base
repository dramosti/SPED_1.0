...
{
    public partial class FormSpedFiscalInventarioLorenzon : Form, IObserverAsynchronousExecution
    {
        private FrontController _FrontController;

        public FormSpedFiscalInventarioLorenzon()
        {
            InitializeComponent();
        }
        ...
        private void btnProcessar_Click(object sender, EventArgs e)
        {
            ...
            InventarioLorenzonProcessController controller =
                new InventarioLorenzonProcessController(parameters);
