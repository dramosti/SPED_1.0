...
{
    public partial class FormSpedFiscalProdutosLorenzon : Form, IObserverAsynchronousExecution
    {
        private FrontController _FrontController;

        public FormSpedFiscalProdutosLorenzon()
        {
            InitializeComponent();
        }
        ...
        private void btnProcessar_Click(object sender, EventArgs e)
        {
            ...
            ProdutosInventarioLorenzonProcessController controller =
                new ProdutosInventarioLorenzonProcessController(parameters);
            controller.Initialize();
            ExecuteAsynchronousControllerDelegate execucaoController =
                new ExecuteAsynchronousControllerDelegate(ExecuteInventarioFiscalLorenzonProcessController);
        ...
        private void ExecuteInventarioFiscalLorenzonProcessController(BaseController controller)
        {
