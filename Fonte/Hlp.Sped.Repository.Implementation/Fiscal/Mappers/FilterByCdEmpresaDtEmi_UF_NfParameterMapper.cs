...
{
    public class FilterByCdEmpresaDtEmi_UF_NfParameterMapper : IParameterMapper
    {
        private readonly Database db;

        public FilterByCdEmpresaDtEmi_UF_NfParameterMapper(Database db)
        {
            this.db = db;
        }
        ...
        public void AssignParameters(DbCommand command, object[] parameterValues)
        {
            ...
            db.SetParameterValue(command, "@CD_UF", parameterValues[3]);
        }
