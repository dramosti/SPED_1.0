...
{
    public class FilterByCdEmpresaDtInveParameterMapper : IParameterMapper
    {        
        private readonly Database db;

        public FilterByCdEmpresaDtInveParameterMapper(Database db)
        {
            this.db = db;
        }
        ...
        public void AssignParameters(DbCommand command, object[] parameterValues)
        {
            ...
            db.SetParameterValue(command, "@DT_INVE", parameterValues[1]);
        }
        ...
        private void InitializeParameters(DbCommand command)
        {
            ...
            if (!command.Parameters.Contains("@DT_INVE"))
            {
                db.AddInParameter(command, "@DT_INVE", DbType.DateTime);
            }
        }
    }
}
