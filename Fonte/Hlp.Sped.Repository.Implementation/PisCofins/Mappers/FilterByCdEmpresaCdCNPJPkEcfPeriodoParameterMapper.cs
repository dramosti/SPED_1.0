...
{
    public class FilterByCdEmpresaCdCNPJPkEcfPeriodoParameterMapper : IParameterMapper
    {
        private readonly Database db;

        public FilterByCdEmpresaCdCNPJPkEcfPeriodoParameterMapper(Database db)
        {
            this.db = db;
        }
        ...
        public void AssignParameters(DbCommand command, object[] parameterValues)
        {
            ...
            db.SetParameterValue(command, "@DT_EMI_INICIAL", parameterValues[3]);
            db.SetParameterValue(command, "@DT_EMI_FINAL", parameterValues[4]);
        }
