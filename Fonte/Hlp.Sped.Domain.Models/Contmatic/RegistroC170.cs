...
namespace Hlp.Sped.Domain.Models.Contmatic
{
    public class RegistroC170 : RegistroBase
    {
        ...
        [CampoDecimal(Ordem = 27, CasasDecimais = 4)]
        ...
        [CampoDecimal(Ordem = 33, CasasDecimais = 4)]
        public decimal? ALIQ_COFINS { get; set; }

        [CampoDecimal(Ordem = 34, CasasDecimais = 3)]
        ...
        [CampoTextoVariavel(Ordem = 37, Tamanho = 60)]
        public string COD_CTA { get; set; }

        [CampoTextoVariavel(Ordem = 38, Tamanho = 3)]
